...
function chooseBackgroundColour() {
    ...
    switch (1) {
        case 1: 
            ...
            $("body .prompt, body .cursor").addClass("redneon-symbols"); 
            break; 
        case 2: 
            //YELLOW
            ...
            $("body .prompt, body .cursor").addClass("yellowneon-symbols"); 
            break; 
        case 3: 
            //GREEN
            ...
            $("body .prompt, body .cursor").addClass("greenneon-symbols"); 
            break; 
        case 4: 
            //BLUE
            ...
            $("body .prompt, body .cursor").addClass("blueneon-symbols"); 
            break; 
    } 
}